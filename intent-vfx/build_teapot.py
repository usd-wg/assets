...
def main():
    ...
    default.GetPrim().GetReferences().AddReference("./geo/UtahTeapot.usd")
    # get default-shapes for later binding
    default_shapes = []
    find_type_or_kind(default_shapes,default.GetPrim(),"Mesh","",False)
    ...
    default_material = build_material(stage,mtl_scope,"default_material")
    default_shader_mtlx = build_mtlx_standard_surface(stage,default_material,"default_shader_mtlx")
    default_shader = build_preview_shader(stage,default_material,"default_shader")
